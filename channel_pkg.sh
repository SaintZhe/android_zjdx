...
channels="web umeng anzhi appchina baidu gfan meizu qihoo360 tencent wandoujia xiaomi huawei lenovo oppo weibo weixin tieba zyzs xytd1 xytd2 xytd3 xytd4 xytd5 xytd6 xytd7 xytd8 xytd9 xytd10 offline"
...
package(){
    for channel in $channels ; do
        ...
        apk=`ls -t -1 $module_name/build/ | grep 'release' | grep 'apk$' | head -1`
